...
function reload()
{
    ...
    if (preferences.minMagnitude.value >= 50) {
        req.open("GET", "http://earthquake.usgs.gov/earthquakes/catalogs/eqs7day-M5.xml", false);
        minLoadedMagnitude = 50;
    } else {
        req.open("GET", "http://earthquake.usgs.gov/earthquakes/catalogs/eqs7day-M2.5.xml", false);
